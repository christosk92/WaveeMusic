...
/// <summary>
/// Constants for Spotify connection protocol.
/// </summary>
internal static class ConnectionConstants
{
    /// <summary>
    /// Spotify server's RSA public key (256 bytes, PKCS#1 format).
    /// Used to verify server's Diffie-Hellman public key signature during handshake.
    /// This prevents man-in-the-middle attacks.
    /// </summary>
    public static ReadOnlySpan<byte> ServerPublicKey =>
    [
    ...
    /// <summary>
    /// Diffie-Hellman prime modulus (96 bytes / 768 bits).
    /// This is the Oakley Group 1 (RFC 2409) prime.
    /// </summary>
    public static ReadOnlySpan<byte> DiffieHellmanPrime =>
    [
    ...
    /// </summary>
    public const byte DiffieHellmanGenerator = 0x02;
}
