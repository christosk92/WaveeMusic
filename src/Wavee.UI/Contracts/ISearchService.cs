...
public interface ISearchService
{
    ...
    /// <summary>
    /// All-chip search — the desktop "Top Results + sections" surface. Returns
    /// the merged Pathfinder shape that the All-tab consumes (tracks / artists /
    /// albums / playlists / podcasts in one envelope).
    /// </summary>
    Task<SearchResult> SearchAllAsync(string query, int limit = 50, int offset = 0, CancellationToken ct = default);
