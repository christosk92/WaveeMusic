...
public sealed class SearchService : ISearchService
{
    ...
    public Task<Wavee.Core.Http.Pathfinder.SearchResult> SearchAllAsync(string query, int limit = 50, int offset = 0, CancellationToken ct = default)
        => _pathfinder.SearchAsync(query, Wavee.Core.Http.Pathfinder.SearchScope.All, limit, offset, ct);
