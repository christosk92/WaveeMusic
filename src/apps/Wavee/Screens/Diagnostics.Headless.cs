...
// the headless command grammar, the wait-condition evaluator, the script runner, the exit codes, the settings overlay,
// the protected credential store, the context-queue builder (the JSON-lines writers are the named partial
// `Diagnostics.Headless.Json.cs`, G-016)
//
// Role: CORE
// Owner: X
