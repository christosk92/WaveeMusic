...
namespace Wavee.Protocol.Storage {
    ...
    static StorageResolveReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "QhtIAqoCFldhdmVlLlByb3RvY29sLlN0b3JhZ2ViBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Wavee.Protocol.Storage.StorageResolveResponse), global::Wavee.Protocol.Storage.StorageResolveResponse.Parser, new[]{ "Result", "Cdnurl", "Fileid" }, null, new[]{ typeof(global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result) }, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Wavee.Protocol.Storage.StorageResolveReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result result_ = global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result.Cdn;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result Result {
      get { return result_; }
      set {
        result_ = value;
      }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Result != global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result.Cdn) hash ^= Result.GetHashCode();
    ...
    #else
      if (Result != global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result.Cdn) {
    ...
    public void MergeFrom(StorageResolveResponse other) {
      ...
      if (other.Result != global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result.Cdn) {
        Result = other.Result;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 8: {
            Result = (global::Wavee.Protocol.Storage.StorageResolveResponse.Types.Result) input.ReadEnum();
            break;
          }
          case 18: {
